...
{
    /**
     * Analyze a lead inquiry using the configured AI provider.
     */
    public function analyze(LeadInquiry $inquiry): LeadInquiry
    {
     ...
     */
    private function buildPrompt(LeadInquiry $inquiry): string
    {
        return <<<PROMPT
    ...
    private function parseResponse(string $response): array
    {
        ...
        return [
            ...
            'service_interest' => trim((string) $data['service_interest']),
