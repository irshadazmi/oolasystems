...
@section('title', 'Edit Contact | Oola Systems')
...
<section class="section-block">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-5">
        ...
        <div>
            ...
            <h1 class="page-title text-start mb-2">Reply to Contact</h1>
            <p class="page-subtitle text-start ms-0">
                Review the contact message and send your response.
            </p>
        </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <textarea
                                ...
                                rows="8"
                                class="form-control"
                                placeholder="Type your response to the customer...">{{ old('response', $contact->response) }}</textarea>
